...
# DEBUG
# Local development: DEBUG=True in .env
# Production: DEBUG=False in Render
...
#
# Production:
#   Render will provide RENDER_EXTERNAL_HOSTNAME
#
ALLOWED_HOSTS = [
    host.strip()
...
# Automatically allow Render's hostname when deployed.
...
# During local development, these allow your frontend
# running through VS Code Live Server to access Django.
#
# Later, we will add your deployed frontend URL
...
# Where collectstatic will put production static files.
